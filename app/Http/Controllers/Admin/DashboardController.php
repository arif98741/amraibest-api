...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $comission = DB::table('vendor_comission')->get();
        ...
        return view('admin.dashboard',compact('pending','comission','total_comission','activation_notify','processing','completed','products','users','blogs','days','sales','pproducts','rorders','poproducts','rusers','referrals','browsers'));
    }
