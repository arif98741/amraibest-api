...
public function index(Request $request)
{
    ...
    $recently_added =  Product::where('status','=',1)->when($gs->affilate_product == 0,
    function($q){
        return $q->where('product_type','=', 'normal');
    })->orderBy('id','desc')->take(8)->get();
    ...
    return view('front.index',compact('ps','sliders','services','top_small_banners','feature_products','recently_added'));
}
