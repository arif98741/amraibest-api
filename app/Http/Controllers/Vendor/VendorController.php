...
class VendorController extends Controller
{
    ...
    public function index()
    {
        ...
        $comission = DB::table('vendor_comission')->where('vendor_id','=', Auth::user()->id)->get();
        $total_comission = $comission->sum('comission');
        $ad = DB::table('admin_commission')->where('vendor_id','=', Auth::user()->id)->get();
        $total_admin_comission = $ad->sum('comission');
        return view('vendor.index',compact('user','pending','processing','completed','total_comission','total_admin_comission'));
    }
