									...
									<div class="content">
										<div class="personal-info">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<input type="text" id="personal-email" class="form-control" name="personal_email" placeholder="Mobile No" value="{{ Auth::check() ? Auth::user()->phone : '' }}"  {!! Auth::check() ? 'readonly' : '' !!}>
												</div>
											</div>
											@if(!Auth::check())
											<div class="row">
		            ...
		            <div class="total-price">
		              ...
		              <p>
						...
						<div class="cupon-box">
                            ...
                            <input class="shipping" type="hidden" value="{{$shipping_total}}">

                            <div class="final-price" style="padding-top: 20px;padding-bottom: 20px;font-weight: bold;">
							<span>Shipping Cost :</span>
								<span>{{ $curr->sign }}{{ $shipping_total}}</span>
						...
						<!--				<input type="radio"   id="free-shepping{{ $data->id }}" name="shipping" value="{{ round($data->price * $curr->value,2) }}" {{ ($loop->first) ? 'checked' : '' }}> -->
