  ...
  <div class="container">
            ...
            <div class="product-price">
              <p class="title">{{ $langg->lang87 }} :</p>
                    <p class="price"><span id="sizeprice">{{ $productt->showPrice() }}</span>
                      ...
                      @if($productt->previous_price !=0)
                      <small style="font-size: 20px;font-weight: bold;color: red;"><sup>{{ round((($productt->previous_price - $productt->price)/$productt->previous_price)*100) }}% off</sup></small>
                      @endif
                      ...
                      <div class="table-area wholesell-details-page">
                        ...
                        <table class="table">
                          ...
                          <tr>
                            ...
                            <td style="color:red">{{ $productt->whole_sell_discount[$key] }}% {{ $langg->lang771 }}</td>
                          </tr>
                          @endforeach
                        </table>
                      </div>
                  ...
                  <div class="product-color">
                    ...
                    <ul class="color-list color-listt">
                      @php
                      $is_first = true;
                      @endphp
                      @foreach($productt->color as $key => $data1)
                      <li class="{{ $is_first ? 'activecolor' : 'unactivecolor' }}">
                        <span class="box boxxx" data-color="{{ $productt->color[$key] }}">{{ $productt->color[$key]}}</span>
                      </li>
                      @php
                      $is_first = false;
                      @endphp
    ...
    <div class="col-lg-3">
        ...
        <table class="table">
          <tr>
            <th>Shipping Cost</th>
            <td>{{$curr->sign}} {{isset($shipping_cost)?$shipping_cost->price:0}}</td>
          </tr>
        </table>
      </div>
