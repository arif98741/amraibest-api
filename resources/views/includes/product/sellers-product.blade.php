                                ...
                                @if($prod->user->is_vendor == 2)
            												...
            												<div class="single-box">
																...
																<div class="right-area">
																		<h4 class="price">{{ $prod->showPrice() }} <del>{{ $prod->showPreviousPrice() }}</del>
                                                                        @if($prod->previous_price !=0)
                      <small style="font-size: 20px;font-weight: bold;color: red;"><sup>{{ round((($prod->previous_price - $prod->price)/$prod->previous_price)*100) }}% off</sup></small>
                      @endif
								...
								@else
										...
										<div class="single-box">
											...
											<div class="right-area">
													<h4 class="price">{{ $prod->showPrice() }} <del>{{ $prod->showPreviousPrice() }}</del> @if($prod->previous_price !=0)
                      <small style="font-size: 20px;font-weight: bold;color: red;"><sup>{{ round((($prod->previous_price - $prod->price)/$prod->previous_price)*100) }}% off</sup></small>
                      @endif</h4>
												<div class="stars">
													<div class="ratings">
