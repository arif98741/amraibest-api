...
<head>
    ...
    @elseif(isset($productt))
        ...
        <meta property="og:image:width" content="61200" />
        <meta property="og:image:height" content="630" />
...
@endif
 ...
 <link href="{{asset('assets/slider/slide-unlock.css')}}" rel="stylesheet">
	@yield('styles')
	...
	<footer class="footer" id="footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-lg-3">
				    						<img src="{{asset('assets/images/footer/qr_amraibest.png')}}" alt="Logo" style="color: #fff;width: 70%;margin:10px;"><br>
     <a target="_blank" href="https://play.google.com/store/apps/details?id=com.amraibestpro.shop"><img src="{{asset('assets/images/footer/Google.png')}}" alt="Logo" style="color: #fff;width: 70%;"></a>
...
<div class="col-lg-6">
 ...
 <div class="form-input">
                          ...
                          @endif
                            ...
                            <input class="mprocessdata" type="hidden"  value="{{ $langg->lang188 }}">
                     <div class="form-forgot" style="margin-left:20px;">
        		                <div class="left">
				                  <input type="checkbox" name="terms"  id="mrp1" checked="checked">
				                  <label for="mrp1">I agree with <a href="https://amraibest.com/term%20and%20conditions%20for%20vendor" target="_blank"> Terms & Policy</a></label>
				                </div>
