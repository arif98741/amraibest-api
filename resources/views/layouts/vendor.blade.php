				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
						   ...
						   <li >
                  <a href="{{route('vendor-messages')}}">{{ $langg->lang232 }}</a>
              </li>

              <li >
                  <a href="{{route('vendor-message-index')}}">{{ $langg->lang204 }}</a>
              </li>

              <li >
                  <a href="{{route('vendor-dmessage-index')}}">{{ $langg->lang250 }}</a>
              </li>
              
              <li>
         <a target="_blank" href="https://tawk.to/chat/5f9f07137f0a8e57c2d8da76/default"> Live Chat With Admin</a>
    </li>
