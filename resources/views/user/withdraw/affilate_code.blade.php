                            ...
                            <div class="edit-info-area">
                                ...
                                <div class="body">
                                        <div class="edit-info-area-form">
                                                ...
                                                <form action="/user/user/affiliate" method="post">
                                                {{ csrf_field() }}
                                                    @include('includes.admin.form-both')
                                                    <div class="form-group row">
                                                      <div class="col-md-4">
                                                        <label style="margin-top:9px" for="affiliate"> Change Affiliate Code: </laebl>
                                                      </div>
                                                      <div class="col-md-4">
                                                        <input class="form-control" id="affiliate" type="text" name="affiliate">
                                                      </div>
                                                      <div class="col-md-4">
