						...
						<div class="order-history">
                         ...
                         <form id="userform" class="form-horizontal" action="{{route('user-wwt-store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div id="Bkash" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-12" for="name">Bkash No *

                                        </label>
                                        <div class="col-sm-12">
                                            <input name="acc_email" placeholder="Bkash No" class="form-control" value="{{ old('email') }}" type="text">
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $("#withmethod").change(function(){
        ...
        if(method == "Bank"){
            ...
            $("#Bkash").hide();
            $("#Bkash").find('input').attr('required',false);
        ...
        if(method != "Bank"){
            ...
            $("#Bkash").show();
            $("#Bkash").find('input').attr('required',true);
        }
        if(method == ""){
            $("#bank").hide();
            $("#Bkash").hide();
