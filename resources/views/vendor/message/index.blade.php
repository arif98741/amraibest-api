                  ...
                  {{ $langg->lang357 }}
                        ...
                        @foreach($convs as $conv)
                          ...
                          <tr class="conv">
                            ...
                            <td>{{$conv->recieved->name}} @if($conv->messages_count !=0)<span style="color:red;">({{$conv->messages_count}})</span>@endif</td>    
                            @else
                            <td>{{$conv->sent->name}} @if($conv->messages_count !=0)<span style="color:red;">({{$conv->messages_count}})</span>@endif</td>      
                            @endif
                            <td>{{$conv->subject}}</td>
                            <td>{{$conv->updated_at->diffForHumans()}}</td>
                            <td>
                              <a href="{{route('vendor-message',$conv->id)}}" class="link view"><i class="fa fa-eye"></i></a>
			...
			<div class="modal-body">
                ...
                <form id="emailreply">
                  ...
                  <ul>
                    ...
                    <li>
                      <input type="text" class="input-field col-md-12" id="eml" name="email" placeholder="Mobile No *" required="">
                    </li>
