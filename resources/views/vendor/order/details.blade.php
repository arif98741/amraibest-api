                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{$shipping_cost->price}}</td>
                                                </tr>
                ...
                @endif
                                @endforeach
                                    ...
                                    <div class="col-lg-12 text-center mt-2">
                                        <a class="btn sendEmail send" href="javascript:;" class="send" data-email="{{ $order->customer_phone }}" data-toggle="modal" data-target="#vendorform">
                        ...
                        <div class="col-md-12">
                            <div class="contact-form">
                                <form id="emailreply">
                                    ...
                                    <ul>
                                        <li>
                                            <input type="text" class="input-field eml-val" id="eml" name="to" placeholder="{{ $langg->lang583 }} *" value="" required="">
                                        </li>
                                        <li>
