                ...
                <div class="col-lg-6">
                        <div class="invoice__shipping">
                           ...
                           <span><strong>{{ $langg->lang557 }}</strong>: {{ $order->shipping_name == null ? $order->customer_name : $order->shipping_name}}</span><br>
                            <span><strong>Phone Number</strong>: {{ $order->shipping_phone == null ? $order->customer_phone : $order->shipping_phone}}</span><br>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               @if($product['color'])
                                                ...
                                                <p>
                                                        <strong>Shipping Cost :</strong> {{$order->currency_sign}}{{ $shipping_cost->price }}
                                                </p>
                                                <p>
                                                        <strong>Wallet Pay :</strong> {{$order->currency_sign}}{{ $order->wallet_price }}
                                                </p>
                                                <p>
                                                        <strong>Voucher Discount :</strong> {{$order->currency_sign}}{{ $order->coupon_discount }}
                                                </p>
                                               <p>
                                            ...
                                            <td>{{$order->currency_sign}}{{ round($product['price'] * $order->currency_value , 2) + $shipping_cost->price - $order->wallet_price - $order->coupon_discount}}</td>
                                            @php
                                ...
                                @endif
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>{{$order->currency_sign}}{{ round($subtotal, 2) + $shipping_cost->price - $order->wallet_price - $order->coupon_discount}}</td>
                                        </tr>
                                        ...
                                        @if($order->tax != 0)
                                        <tr>
                                            <td colspan="2">{{ $langg->lang599 }}({{$order->currency_sign}})asdf</td>
                                            @php
                                        ...
                                        <tr>
                                            <td colspan="1"></td>
                                            <td>{{ $langg->lang600 }}</td>
                                            <td>{{$order->currency_sign}}{{ round(($subtotal + $data + $shipping_cost->price - $order->wallet_price - $order->coupon_discount), 2) }}
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
