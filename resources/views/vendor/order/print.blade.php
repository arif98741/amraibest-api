            ...
            <div class="invoice__metaInfo" style="margin-top:0px;">
                ...
                <div class="col-lg-6">
                        <div class="invoice__orderDetails" style="margin-top:5px;">
                           ...
                           <span><strong>Phone</strong>: {{ $order->shipping_phone == null ? $order->customer_phone : $order->shipping_phone }}</span><br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <p>
                                                    <strong>Wallet Pay :</strong> {{$order->wallet_price}}
                                               </p>
                                               <p>
                                                    <strong>Vouher Pay :</strong> {{$order->coupon_discount}}
                                               </p>
                                               <p>
                                                    <strong>{{ $langg->lang595 }} :</strong> {{$product['qty']}} {{ $product['item']['measure'] }}
                                               </p>
                                            ...
                                            <td>{{$order->currency_sign}}{{ round($product['price'] * $order->currency_value , 2) - $order->wallet_price - $order->coupon_discount }}
                                            </td>
                                            @php
                                            $subtotal += round($product['price'] * $order->currency_value, 2) - $order->wallet_price - $order->coupon_discount;
                                            @endphp
