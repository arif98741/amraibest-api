...
Route::prefix('admin')->group(function() {
  ...
  //----------Vendor Comission Section ---------------
  Route::get('/vendor-comission','Admin\VendorComissionController@index');
  Route::post('/vendor-comission/make-paid','Admin\VendorComissionController@makepaid');
  Route::get('/vendor-comission/make-request/{id}/{amount}','Admin\VendorComissionController@requestpayment');

  //----------Admin Comission Section ---------------
  Route::get('/admin-comission','Admin\AdminComissionController@index');
  Route::post('/admin-comission/make-paid','Admin\AdminComissionController@makepaid');
  Route::get('/admin-comission/make-request/{id}/{amount}','Admin\AdminComissionController@requestpayment');



  //----------End Vendor Comission Section--------------
...
Route::prefix('user')->group(function() {
  ...
  //send otp
    ...
    Route::post('/sendOtp-user', 'User\RegisterController@sendOtp')->name('user.otp.send');
...
// User Subscription
  ...
  Route::post('/user/affiliate','User\WithdrawController@affiliate_update');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/messages', 'Vendor\MessageController@messages')->name('vendor-messages');
  Route::get('/message/{id}', 'Vendor\MessageController@message')->name('vendor-message');
   // Tickets
  Route::get('admin/tickets', 'Vendor\MessageController@adminmessages')->name('vendor-message-index');
    Route::get('admin/message/{id}', 'Vendor\MessageController@adminmessage')->name('vendor-message-show');


  // Disputes
  Route::get('admin/disputes', 'Vendor\MessageController@adminDiscordmessages')->name('vendor-dmessage-index');
